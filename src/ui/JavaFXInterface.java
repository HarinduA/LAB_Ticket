...
// Choose a TicketRetrievalStrategy (e.g., PriorityRetrieval for FIFO)
...
customerThread = new Thread(new Customer(ticketPool, retrievalStrategy)); // Pass the strategy here
